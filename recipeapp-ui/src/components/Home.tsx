    ...
    return (
        <>
            ...
            <div className="text-[#fafafa] w-3/5 mx-auto">
                <p className="mb-8"><span className="font-bold text-lg text-[#DCF938]">Transform the way you plan your meals</span> with our intuitive recipe and shopping list app! Designed to simplify your weekly routine, 
                ...
                <p className="mb-8"><span className="font-bold text-lg text-[#DCF938]"> Our recipe database features a variety of dishes </span>to suit different tastes and dietary preferences. 
                ...
                <p className="mb-8"><span className="font-bold text-lg text-[#DCF938]">The app is built to save you time</span>, reduce stress, and help you maintain a well-organized kitchen. 
