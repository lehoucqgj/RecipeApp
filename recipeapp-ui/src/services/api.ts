import type { Recipe, RecipeIngredientDetails, createRecipeWithIngredientsData, Ingredient } from '../types';
...
export const recipeApi = {
    ...
    createIngredient: (data: Ingredient) => post<Ingredient>('/ingredient', data)
